...
import com.buddha.icbi.mapper.mapper.member.MemberCollectionMapper;
 ...
 */
@Service
public class MemberCollectionService extends ServiceImpl<MemberCollectionMapper, MemberCollection> {
